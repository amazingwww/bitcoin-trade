...
function basic_setup() {
	...
	// Register Navigation
	register_nav_menus(array('primary' => 'Primary Navigation', 'secondary' => 'Secondary Navigation', 'main-menu' => 'Menu Level 3', 'footer' => 'Footer Navigation'));
...
function basic_scripts() {
	...
	wp_enqueue_script('slideout', get_template_directory_uri().'/js/slideout.min.js', array(), '', true);
